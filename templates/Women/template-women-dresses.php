            ...
            <div class="row" id="product-container">
                    ...
                    if ($products->have_posts()) {
                        ...
                        <div class="col-sm-6 col-xl-4 product-item"
                             data-category="<?php echo $product_category_ids; ?> "
                            ...
                            <div class="sin-product style-two">
                                ...
                                <div class="mid-wrapper">
                                    ...
                                    <p><?php echo $product_type; ?> /
                                        <span>$<?php echo $product_price; ?></span></p>
                                </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <?php
                                    ...
                                    <div class="sin-product list-pro"
                                            ...
                                            <div class="col-md-7 col-lg-6 col-xl-8">
                                                <div class="list-pro-det">
                                                    <h5 class="pro-title"><a
                                                            href="#"><?php echo  $product_title;  ?></a></h5>
                                        ...
                                        <form class="add-to-carts" method="post" action="<?php echo esc_url( wc_get_cart_url() ); ?>">
                                            <input type="hidden" name="add-to-cart" value="<?php echo esc_attr( $product_id ); ?>">
                                            <button type="submit" class="button alt">Add to Cart</button>
                                            <?php wp_nonce_field( 'woocommerce-add-to-cart', 'woocommerce-add-to-cart-nonce' ); ?>
                                        </form>
