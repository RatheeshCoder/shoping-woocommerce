...
function changeLanguage() {
  ...
  var selectedLanguage = languageSelect.options[languageSelect.selectedIndex].text;
  console.log('Selected language:', selectedLanguage);
  // You can add further logic or actions based on the selected language.
}
...
function changeCurrency() {
  ...
  // You can add further logic or actions based on the selected currency.
}


// Function to update the cart product count
function updateCartProductCount() {
  var cartProductCountElement = document.getElementById('cart-product-count');
  var cartProductCount = cartProductCountElement.getAttribute('data-count');
  cartProductCountElement.textContent = '(' + cartProductCount + ')';
}

// Call the function to update the cart product count on page load
